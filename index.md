...
- Hash Functions
  - Content-addressable storage (Venti/IPFS)
  - Merkel Tree (Block Chain/IPFS)
- Know/Understand basic OWASP Attacks
- Functional Programming
- Immutable Programming/Datastructures
- Recursion
- Distributed Systems
  - Chaos Engineering
- Design by Contract
